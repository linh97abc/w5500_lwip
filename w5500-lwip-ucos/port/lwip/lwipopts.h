...
#define LWIP_SO_RCVTIMEO        1 // Ð­Ñ‚Ð° Ð¾Ð¿Ñ†Ð¸Ñ� Ð½ÐµÐ¾Ð±Ñ…Ð¾Ð´Ð¸Ð¼Ð° Ð´Ð»Ñ� netconn_set_recvtimeout Ð² Ð¼Ð¾Ð´ÑƒÐ»Ðµ udp_netsetting.c
...
#define LWIP_UCOSII_TASK_STK_SIZE 1024
#define LWIP_UCOSII_MAX_NUM_OF_TASK 8
#define LWIP_UCOSII_MAILBOX_SIZE 128
#define LWIP_UCOSII_MAX_NUM_OF_MAILBOX 16
#define LWIP_W5x00_TASK_PRIO 1
